...
mod test {
    ...
    fn test_footprint_module() {
        ...
        let _ = env_logger::init();
        let s = r#"
(module SOT-23 (layer F.Cu) (tedit 574C50E6)
  (descr "generic SOT-23 footprint") 
  (fp_text reference U1 (at 2.3 0) (layer F.SilkS) (effects (font (size 0.625 0.625) (thickness 0.1))))
  ...
  (fp_line (start 1.5 -1.5) (end -1.5 -1.5) (layer F.SilkS) (width 0.1))
  (fp_line (start -1.5 -1.5) (end -1.5 1.5) (layer F.SilkS) (width 0.1))
  (fp_poly (pts (xy -0.25 -1.15) (xy -0.25 -0.65) (xy 0.25 -0.65) (xy 0.25 -1.15) (xy -0.25 -1.15)) (layer Dwgs.User) (width 0.15))
